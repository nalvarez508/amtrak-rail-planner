        ...
        if not self.deleted:
            if 0 - 50 < canvas_pos_x < self.map_widget.width + 50 and 0 < canvas_pos_y < self.map_widget.height + 70:
                if self.polygon is None:
                    self.polygon = self.map_widget.canvas.create_polygon(canvas_pos_x - 0, canvas_pos_y - 0, #14,23
                                                                         canvas_pos_x, canvas_pos_y,
                                                                         canvas_pos_x + 0, canvas_pos_y - 0,
                    ...
                    self.map_widget.canvas.coords(self.polygon,
                                                  canvas_pos_x - 0, canvas_pos_y - 0, #14,23
                                                  canvas_pos_x, canvas_pos_y,
                                                  canvas_pos_x + 0, canvas_pos_y - 0)
                if self.big_circle is None:
                    self.big_circle = self.map_widget.canvas.create_oval(canvas_pos_x - 3, canvas_pos_y - 3, #-14,-45
                                                                         canvas_pos_x + 3, canvas_pos_y + 3, #+14,-17
                    ...
                    self.map_widget.canvas.coords(self.big_circle,
                                                  canvas_pos_x - 3, canvas_pos_y - 3, #14,45
                                                  canvas_pos_x + 3, canvas_pos_y + 3) #14,17

                if self.text is not None:
                    if self.canvas_text is None:
                        self.canvas_text = self.map_widget.canvas.create_text(canvas_pos_x, canvas_pos_y - self.text_offset, #56
                                                                              anchor=tkinter.S,
                                                                              text=self.text,
                        ...
                        self.map_widget.canvas.coords(self.canvas_text, canvas_pos_x, canvas_pos_y - self.text_offset)
